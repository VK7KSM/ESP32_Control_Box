...
pub struct RadioState {
    ...
    pub sql_override_side_is_left: Option<bool>, // Some(side) = 本次 SQL 注入锁定物理侧，None = 兼容旧逻辑按当前 MAIN
    ...
    pub rigctld_tx_pending_hz: Option<u64>,
    pub rigctld_rx_pending_since_us: u64,
    pub rigctld_tx_pending_since_us: u64,
    pub rigctld_setup_pair_since_us: u64,
    pub rigctld_rx_log_us: u64,
    pub rigctld_tx_log_us: u64,
    pub rigctld_setup_rx_hz: Option<u64>,
    pub rigctld_setup_tx_hz: Option<u64>,
    pub rigctld_setup_snapshot_ready: bool,
    pub rigctld_setup_attempts: u8,
    pub rigctld_setup_retry_after_us: u64,
    pub rigctld_rx_target_hz: Option<u64>,
    pub rigctld_tx_target_hz: Option<u64>,
    pub rigctld_rx_initial_attempted: bool,
    pub rigctld_tx_initial_attempted: bool,
    pub rigctld_rx_initial_done: bool,
    pub rigctld_tx_initial_done: bool,
    pub rigctld_rx_step_ready: bool,
    pub rigctld_tx_step_ready: bool,
    pub rigctld_sat_retry_after_us: u64,
    pub rigctld_rx_last_step_us: u64,
    pub rigctld_tx_last_step_us: u64,
    pub rigctld_tx_ctcss_tone: u32,
    pub rigctld_tx_ctcss_dirty: bool,
    pub rigctld_tx_ctcss_done: bool,
    ...
    pub rigctld_tone_off_tx_done: bool,
    pub rigctld_tx_placeholder_active: bool,
...
impl RadioState {
    pub fn new() -> Self {
        Self {
            ...
            vol_changed: false,
            sql_changed: false,
            sql_override_side_is_left: None,
            main_probed: false,
            ...
            rigctld_tx_pending_hz: None,
            rigctld_rx_pending_since_us: 0,
            rigctld_tx_pending_since_us: 0,
            rigctld_setup_pair_since_us: 0,
            rigctld_rx_log_us: 0,
            rigctld_tx_log_us: 0,
            rigctld_setup_rx_hz: None,
            rigctld_setup_tx_hz: None,
            rigctld_setup_snapshot_ready: false,
            rigctld_setup_attempts: 0,
            rigctld_setup_retry_after_us: 0,
            rigctld_rx_target_hz: None,
            rigctld_tx_target_hz: None,
            rigctld_rx_initial_attempted: false,
            rigctld_tx_initial_attempted: false,
            rigctld_rx_initial_done: false,
            rigctld_tx_initial_done: false,
            rigctld_rx_step_ready: false,
            rigctld_tx_step_ready: false,
            rigctld_sat_retry_after_us: 0,
            rigctld_rx_last_step_us: 0,
            rigctld_tx_last_step_us: 0,
            rigctld_tx_ctcss_tone: 0,
            rigctld_tx_ctcss_dirty: false,
            rigctld_tx_ctcss_done: true,
            ...
            rigctld_tone_off_tx_done: false,
            rigctld_tx_placeholder_active: false,
